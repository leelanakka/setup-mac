...
#installing syntacx highlighting
...
git config --global user.name "Nakka LeelaPrasanth";
git config --global user.email "44019459+leelanakka@users.noreply.github.com";
